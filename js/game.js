...
var deflector = new Entity("Deflector", 25, 25, VIEWPORT.width / 2 + 100, VIEWPORT.height / 2 + 200, Entity.DYNAMIC, "#0000ff", "#000000", 0.05, 1, null, -5, 5);
...
var collider1 = new Entity("Collider A", 50, 100, VIEWPORT.width / 2 - 425, VIEWPORT.height / 2 - 50, Entity.DYNAMIC, "#0000ff", "#000000", 0.5, 0.5, null, 0, 5, 3);
var collider2 = new Entity("Collider B", 50, 100, VIEWPORT.width / 2 - 375, VIEWPORT.height / 2 + 25, Entity.DYNAMIC, "#0000ff", "#000000", 0.5, 0.5, null, 0, -5, -3);
